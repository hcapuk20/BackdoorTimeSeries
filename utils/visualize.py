...
def visualize(latents, poisoned_indices, silent_indices, args):
    ...
    silent = f"silent_a{args.lambda_alpha}b{args.lambda_beta}" if args.silent_poisoning else "_"
    os.makedirs('visuals', exist_ok=True)
    save_path = f'visuals/latent_{dataset}_{args.bd_model}_{args.model}_{args.train_mode}_{silent}_ls-{args.label_smooth}_{args.sim_id}.png'
    plt.tight_layout()
